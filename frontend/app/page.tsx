...
export default function HomePage() {
  ...
  useEffect(() => {
    // Redirect authenticated users to emails page
  ...
  if (status === "authenticated") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <p className="text-gray-600">Redirecting to your emails...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to manage your emails with AI assistance
          </p>
        </div>
        ...
        <div className="text-center text-xs text-gray-500">
          <p>By signing in, you agree to access your Gmail for email automation.</p>
        </div>
      </div>
    </div>
  );
